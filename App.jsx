...
import Partylepraalabstck from './PartyLepraaLabSrc/partylepraalabnav/Partylepraalabstck';
import Partylepraalabldr from './PartyLepraaLabSrc/partylepraalabcmpnts/Partylepraalabldr';
import { ContextProvider } from './PartyLepraaLabSrc/partylepraalabstr/partylepraalabmuscntx';
import { NavigationContainer } from '@react-navigation/native';
import ProductScreen from './PartyLepraaLabSrc/partylepraalabscrns/ProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://fresh-bridge-plus.site/`;
  const URL_IDENTIFAIRE = `Zdc2U1yg`;
  ...
  OneSignal.initialize('4d79a2bf-50e9-4c79-a550-82cdca7df213');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-11-27T08:08:00'); //дата з якої поч працювати webView
